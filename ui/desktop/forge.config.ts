...
const isLinuxVulkanBuild = process.env.INDRA_DESKTOP_LINUX_VARIANT === 'vulkan';
...
let cfg = {
  ...
  extendInfo: {
    ...
    NSMicrophoneUsageDescription:
      'INDRA needs access to your microphone for voice dictation.',
    NSAppleEventsUsageDescription:
      'INDRA needs access to send Apple Events to control other apps on your behalf.',
  },
};
  ...
  publishers: [
    {
      ...
      config: {
        repository: {
          owner: process.env.GITHUB_OWNER || 'HariKarthick22',
          name: process.env.GITHUB_REPO || 'indra',
        },
        prerelease: false,
        draft: true,
      },
