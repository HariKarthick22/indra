export const configLabels: Record<string, string> = {
  // goose settings
  INDRA_PROVIDER: 'Provider',
  INDRA_MODEL: 'Model',
  INDRA_TEMPERATURE: 'Temperature',
  INDRA_MODE: 'Mode',
  INDRA_PLANNER_PROVIDER: 'Planner Provider',
  INDRA_PLANNER_MODEL: 'Planner Model',
  INDRA_TOOLSHIM: 'Tool Shim',
  INDRA_TOOLSHIM_OLLAMA_MODEL: 'Tool Shim Ollama Model',
  INDRA_CLI_MIN_PRIORITY: 'CLI Min Priority',
  INDRA_ALLOWLIST: 'Allow List',
  INDRA_RECIPE_GITHUB_REPO: 'Recipe GitHub Repo',
