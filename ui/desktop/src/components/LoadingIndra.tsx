...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'INDRA is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'INDRA is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'INDRA is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'INDRA is compacting the conversation...',
  },
  idle: {
