...
const i18n = defineMessages({
  ...
  noSkillsDescription: {
    ...
    defaultMessage:
      'Skills are loaded from SKILL.md files in ~/.config/agents/skills/, .indra/skills/, or other supported directories.',
  },
  noMatchingSkills: {
  ...
  skillsDescription: {
    ...
    defaultMessage: 'View installed skills that extend INDRA capabilities. {shortcut} to search.',
  },
