...
const i18n = defineMessages({
  ...
  importNostrDesc: {
    ...
    defaultMessage: 'Paste an INDRA Nostr share link to fetch, decrypt, and import the session.',
  },
  ...
  chatHistoryDesc: {
    ...
    defaultMessage: 'View and search your past conversations with INDRA. {shortcut} to search.',
  },
...
const SessionListView: React.FC<SessionListViewProps> = React.memo(({ onSelectSession }) => {
  ...
  useEffect(() => {
    ...
    if (config.INDRA_DISABLE_NOSTR_SHARING === true) {
