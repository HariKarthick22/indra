...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Edit your INDRA configuration settings',
  },
  descriptionWithProvider: {
    id: 'configSettings.descriptionWithProvider',
    defaultMessage: 'Edit your INDRA configuration settings (current settings for {provider})',
  },
  editConfiguration: {
...
export default function ConfigSettings() {
  ...
  const currentProvider = typedConfig.INDRA_PROVIDER || '';
