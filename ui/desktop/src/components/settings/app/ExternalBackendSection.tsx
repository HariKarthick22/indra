...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default INDRA starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. INDRA checks /status and connects to /acp under this base.',
  },
  workingDir: {
  ...
  workingDirPlaceholder: {
    ...
    defaultMessage: '/home/indra/workspace',
  },
  workingDirHelp: {
  ...
  secretKeyHelp: {
    ...
    defaultMessage: 'The secret key configured on the external backend (INDRA_SERVER__SECRET_KEY).',
  },
  certFingerprint: {
  ...
  restartNote: {
    ...
    defaultMessage: 'Changes apply to new chat windows. Restart INDRA to update existing windows.',
  },
  urlProtocolError: {
