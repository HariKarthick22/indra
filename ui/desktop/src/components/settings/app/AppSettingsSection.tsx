...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how INDRA appears on your system',
  },
  ...
  helpDesc: {
    ...
    defaultMessage: 'Help us improve INDRA by reporting issues or requesting new features',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install updates to keep INDRA running at its best',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select INDRA in the application list',
  },
...
export default function AppSettingsSection({ scrollToSection }: AppSettingsSectionProps) {
  ...
  const shouldShowUpdates = !window.appConfig.get('INDRA_VERSION');
  ...
  return (
    <div className="space-y-4 pr-4 pb-8 mt-1">
      ...
      {/* Version Section - only show if INDRA_VERSION is set */}
      {!shouldShowUpdates && (
        <Card className="rounded-lg">
          <CardHeader className="pb-0">
          ...
          <CardContent className="pt-4 px-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-mono text-black dark:text-white">
                {String(window.appConfig.get('INDRA_VERSION') || 'Development')}
              </span>
            </div>
          </CardContent>
        </Card>
      ...
      {/* Update Section - only show if INDRA_VERSION is NOT set */}
