...
const i18n = defineMessages({
  ...
  disableAutoDownloadDesc: {
    ...
    defaultMessage:
      'When enabled, INDRA will notify you of new versions but will not download them automatically.',
  },
  autoDownloadDisabledByEnv: {
    id: 'updateSection.autoDownloadDisabledByEnv',
    defaultMessage:
      'Automatic downloads are disabled via the INDRA_DISABLE_AUTO_DOWNLOAD environment variable.',
  },
  downloadNow: {
  ...
  autoDownload: {
    ...
    defaultMessage:
      'INDRA will download the update in the background and install it the next time you quit or restart.',
  },
});
