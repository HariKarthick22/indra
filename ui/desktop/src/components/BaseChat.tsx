  ...
  return (
    <div className="h-full flex flex-col min-h-0">
      ...
      >
        ...
        <div className="flex flex-col flex-1 min-h-0 relative">
          {/* INDRA watermark - top right */}
          <div className="absolute top-[14px] right-4 z-[60] flex flex-row items-center gap-1.5">
            <div className="no-drag flex flex-row items-center gap-1.5 px-2.5 py-1 rounded-full bg-background-secondary/80 backdrop-blur-md border border-border-primary/60 text-text-secondary text-xs font-medium tracking-wide shadow-sm hover:border-border-secondary transition-all duration-200">
