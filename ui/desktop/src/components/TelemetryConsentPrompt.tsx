...
const i18n = defineMessages({
  heading: {
    ...
    defaultMessage: 'Help improve INDRA',
  },
  description: {
    id: 'telemetryConsentPrompt.description',
    defaultMessage:
      'Would you like to share anonymous usage data to help improve INDRA? We never collect your conversations, code, or personal data.',
  },
  learnMore: {
...
const TELEMETRY_CONFIG_KEY = 'INDRA_TELEMETRY_ENABLED';
...
export default function TelemetryConsentPrompt() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const provider = await read('INDRA_PROVIDER', false);
