...
const PLATFORM_PACKAGES: Record<string, string> = {
  "darwin-arm64": "@aaif/indra-binary-darwin-arm64",
  "darwin-x64": "@aaif/indra-binary-darwin-x64",
  "linux-arm64": "@aaif/indra-binary-linux-arm64",
  "linux-x64": "@aaif/indra-binary-linux-x64",
  "win32-x64": "@aaif/indra-binary-win32-x64",
};
