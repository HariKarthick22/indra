...
INDRA is a sovereign AI agent framework in Rust with CLI and Electron desktop interfaces.

## Contribution Workflow

The issue is the source of truth for work intended for an upstream pull request. Track issue status on the [INDRA Issues board](https://github.com/orgs/aaif-goose/projects/1).
