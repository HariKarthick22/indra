...
use indra::acp::{AcpProvider, AcpProviderConfig};
use indra::config::{GooseMode, PermissionManager};
use indra::conversation::message::{ActionRequiredData, Message, MessageContent};
use indra::permission::permission_confirmation::PrincipalType;
use indra::permission::{Permission, PermissionConfirmation};
use indra::providers::base::Provider;
use indra_providers::model::ModelConfig;
use indra_test_support::{ExpectedSessionId, IgnoreSessionId, TEST_MODEL};
...
impl AcpProviderSession {
    ...
    async fn send_message(
        ...
        let mut stream = indra::session_context::with_session_id(
