...
use indra::agents::{Agent, AgentEvent, GoosePlatform};
use indra::config::extensions::{set_extension, ExtensionEntry};
...
mod tests {
    ...
    mod schedule_tool_tests {
        ...
        use indra::agents::platform_extensions::scheduler::{
            EXTENSION_NAME as SCHEDULER_EXTENSION_NAME, MANAGE_SCHEDULE_TOOL_NAME_COMPLETE,
        };
        use indra::agents::ExtensionConfig;
        use indra::agents::{AgentConfig, ScheduleTool};
        use indra::config::permission::PermissionManager;
        use indra::config::GooseMode;
        use indra::scheduler::{ScheduledJob, SchedulerError, ValidatedScheduleRecipe};
        use indra::scheduler_trait::SchedulerTrait;
        use indra::session::{Session, SessionManager};
    ...
    mod retry_tests {
        use super::*;
        use indra::agents::types::{RetryConfig, SuccessCheck};

        #[tokio::test]
        async fn test_retry_success_check_execution() -> Result<()> {
            use indra::agents::retry::execute_success_checks;
    ...
    mod max_turns_tests {
        use super::*;
        use async_trait::async_trait;
        use indra::agents::SessionConfig;
        use indra::config::GooseMode;
        use indra::conversation::message::{Message, MessageContent};
        use indra::providers::base::{
            stream_from_single_message, MessageStream, Provider, ProviderDef, ProviderMetadata,
        };
        use indra::session::session_manager::SessionType;
        use indra_providers::conversation::token_usage::{ProviderUsage, Usage};
        ...
        impl indra::providers::base::ProviderDescriptor for MockToolProvider {
        ...
        impl ProviderDef for MockToolProvider {
            ...
            fn from_env(
                _extensions: Vec<indra::config::ExtensionConfig>,
                _tls_config: Option<indra::providers::api_client::TlsConfig>,
            ...
            while let Some(response_result) = reply_stream.next().await {
                match response_result {
                    Ok(AgentEvent::Message(response)) => {
                        ...
                        {
                            if let indra::conversation::message::ActionRequiredData::ToolConfirmation { id, .. } = &action.data {
                                agent
                                    .submit_tool_confirmation(
                                        &session_id,
                                        id,
                                        indra::permission::Permission::AllowOnce,
                                    )
                                    .await?;
                            }
                        }
    ...
    mod unparseable_tool_call_tests {
        use super::*;
        use async_trait::async_trait;
        use indra::agents::{AgentConfig, SessionConfig};
        use indra::config::permission::PermissionManager;
        use indra::config::GooseMode;
        use indra::conversation::message::{Message, MessageContent};
        use indra::providers::base::{
        ...
        impl indra::providers::base::ProviderDescriptor for UnparseableToolProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod tool_pair_summarization_tests {
        ...
        use async_trait::async_trait;
        use indra::agents::{AgentConfig, SessionConfig};
        use indra::config::base::Config;
        use indra::config::permission::PermissionManager;
        use indra::config::GooseMode;
        use indra::conversation::message::Message;
        use indra::providers::base::{
            stream_from_single_message, MessageStream, Provider, ProviderDef, ProviderMetadata,
        };
        use indra::session::{SessionManager, SessionType};
        use indra_providers::conversation::token_usage::{ProviderUsage, Usage};
        use indra_providers::errors::ProviderError;
        use indra_providers::model::ModelConfig;
        ...
        impl indra::providers::base::ProviderDescriptor for SummarizationTestProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod extension_manager_tests {
        use super::*;
        use indra::agents::extension::ExtensionConfig;
        use indra::agents::platform_extensions::{
            MANAGE_EXTENSIONS_TOOL_NAME, SEARCH_AVAILABLE_EXTENSIONS_TOOL_NAME,
        };
        use indra::agents::AgentConfig;
        use indra::config::permission::PermissionManager;
        use indra::config::GooseMode;
        use indra::session::SessionManager;
    ...
    mod streaming_persistence_tests {
        ...
        use indra::config::GooseMode;
        use indra::conversation::message::Message;
        use indra::providers::base::{MessageStream, Provider, ProviderDef, ProviderMetadata};
        use indra::session::session_manager::SessionType;
        use indra::session::SessionManager;
        use indra_providers::conversation::token_usage::{ProviderUsage, Usage};
        use indra_providers::errors::ProviderError;
        ...
        impl indra::providers::base::ProviderDescriptor for MultiStepProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod thinking_preservation_tests {
        ...
        impl indra::providers::base::ProviderDescriptor for ThinkingStreamProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        fn assert_formatter_adds_reasoning_to_tool_calls(messages: &[Message], provider: &str) {
            use indra_providers::formats::openai::{
                format_messages_with_options, OpenAiFormatOptions,
            };
            use indra_providers::images::ImageFormat;
        ...
        impl indra::providers::base::ProviderDescriptor for CombinedThinkingToolProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        impl indra::providers::base::ProviderDescriptor for MultiToolThinkingProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        async fn test_signed_thinking_not_duplicated_for_anthropic() -> Result<()> {
            use indra_providers::formats::anthropic::format_messages as anthropic_format;
    ...
    mod goal_checking_tests {
        ...
        impl indra::providers::base::ProviderDescriptor for GoalTextProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
    ...
    mod cumulative_token_tests {
        ...
        use indra::config::GooseMode;
        use indra::conversation::message::Message;
        use indra::providers::base::{stream_from_single_message, MessageStream, Provider};
        use indra::session::session_manager::SessionType;
        use indra::session::SessionManager;
        use indra_providers::conversation::token_usage::{ProviderUsage, Usage};
        use indra_providers::errors::ProviderError;
    ...
    mod add_extensions_bulk_tests {
        ...
        use indra::agents::{AgentConfig, ExtensionConfig};
        use indra::config::permission::PermissionManager;
        use indra::config::GooseMode;
        use indra::session::session_manager::SessionType;
        use indra::session::{
    ...
    mod audience_tool_result_tests {
        ...
        use async_trait::async_trait;
        use indra::agents::{AgentConfig, SessionConfig};
        use indra::config::{ExtensionConfig, GooseMode, PermissionManager};
        use indra::conversation::message::{Message, MessageContent};
        use indra::providers::base::{stream_from_single_message, MessageStream, Provider};
        use indra::session::{SessionManager, SessionType};
        use indra_providers::conversation::token_usage::{ProviderUsage, Usage};
        use indra_providers::errors::ProviderError;
        use indra_providers::model::ModelConfig;
        use indra_test_support::McpFixture;
        use rmcp::model::{CallToolRequestParams, Tool};
        use std::path::PathBuf;
        use std::sync::atomic::{AtomicUsize, Ordering};
    ...
    mod empty_turn_tests {
        use super::*;
        use async_trait::async_trait;
        use indra::agents::final_output_tool::FINAL_OUTPUT_TOOL_NAME;
        use indra::agents::{AgentConfig, AgentEvent, GoosePlatform, SessionConfig};
        use indra::config::permission::PermissionManager;
        use indra::config::GooseMode;
        use indra::conversation::message::{Message, MessageContent};
        use indra::conversation::Conversation;
        use indra::providers::base::{
            stream_from_single_message, MessageStream, Provider, ProviderDef, ProviderMetadata,
        };
        use indra::session::session_manager::SessionType;
        ...
        impl indra::providers::base::ProviderDescriptor for AssistantOnlyProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        impl indra::providers::base::ProviderDescriptor for EmptyThenTextProvider {
            fn metadata() -> ProviderMetadata {
                ProviderMetadata {
        ...
        async fn test_empty_turn_with_final_output_tool_nudges() -> Result<()> {
            use indra::agents::final_output_tool::FINAL_OUTPUT_CONTINUATION_MESSAGE;
            use indra::recipe::Response;
