...
use indra::providers::api_client::{ApiClient, AuthMethod};
use indra::providers::base::Provider;
use indra::providers::openai::OpenAiProvider;
use indra::session_context::{session_id_request_builder, SESSION_ID_HEADER};
...
async fn make_request(provider: &dyn Provider, session_id: &str) {
    ...
    let _ = indra::session_context::with_session_id(
