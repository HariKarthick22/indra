...
use indra::agents::extension_manager::{ExtensionManager, ExtensionManagerCapabilities};
...
impl indra::providers::base::ProviderDescriptor for MockProvider {
...
async fn test_replayed_session(
    ...
    let session_manager = Arc::new(indra::session::SessionManager::new(
