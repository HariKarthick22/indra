...
use indra::agents::{Agent, AgentEvent, ExtensionConfig, SessionConfig};
use indra::config::{GooseMode, DEFAULT_EXTENSION_DESCRIPTION, DEFAULT_EXTENSION_TIMEOUT};
...
async fn main() -> anyhow::Result<()> {
    ...
    let model_config =
        indra::model_config::model_config_from_user_config("databricks", DATABRICKS_DEFAULT_MODEL)?;
