pub use indra_providers::canonical::catalog::{
...
pub async fn get_providers_by_format(format: ProviderFormat) -> Vec<ProviderCatalogEntry> {
    ...
    indra_providers::canonical::catalog::get_providers_by_format(format, &native_provider_ids)
}

pub async fn get_setup_catalog_entries() -> Vec<ProviderSetupCatalogEntry> {
    indra_providers::canonical::catalog::get_setup_catalog_entries(
        super::providers()
            .await
            .into_iter()
...
pub fn get_provider_template(provider_id: &str) -> Option<ProviderTemplate> {
    indra_providers::canonical::catalog::get_provider_template(provider_id)
}
