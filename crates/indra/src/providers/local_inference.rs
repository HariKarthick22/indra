pub use indra_providers::local_inference::*;
...
fn resolve_model_settings(
    model_id: &str,
) -> Result<Option<indra_providers::local_inference::model::ModelSettings>> {
    let settings = crate::config::Config::global()
        .get_param::<HashMap<String, indra_providers::local_inference::model::ModelSettings>>(
...
fn write_model_settings(
    model_id: &str,
    settings: &indra_providers::local_inference::model::ModelSettings,
) -> Result<()> {
    crate::config::Config::global().update_param::<HashMap<
        String,
        indra_providers::local_inference::model::ModelSettings,
