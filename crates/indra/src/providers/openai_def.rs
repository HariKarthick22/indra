...
use indra_providers::base::ProviderDescriptor;
...
use indra_providers::api_client::{ApiClient, AuthMethod};
use indra_providers::openai::{
...
impl ProviderDescriptor for OpenAiProviderDef {
    fn metadata() -> indra_providers::base::ProviderMetadata {
...
pub async fn from_env(
    tls_config: Option<indra_providers::api_client::TlsConfig>,
...
pub fn from_custom_config(
    ...
    indra_providers::openai::from_declarative_config(
        config,
        tls_config,
