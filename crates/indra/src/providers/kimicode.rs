...
use indra_providers::formats::anthropic::AnthropicFormatOptions;
...
impl KimiCodeProvider {
    ...
    async fn post(&self, payload: &Value) -> Result<reqwest::Response, ProviderError> {
        ...
        indra_providers::http_status::send_bounded(
            request,
...
impl indra_providers::base::ProviderDescriptor for KimiCodeProvider {
