...
use indra_providers::formats::openai::extract_reasoning_effort;
use indra_providers::formats::openai_responses::create_responses_request;
...
impl BedrockProvider {
    ...
    async fn post_mantle_streaming(
        ...
        let response = indra_providers::http_status::send_bounded(
            req,
...
impl indra_providers::base::ProviderDescriptor for BedrockProvider {
...
mod tests {
    use super::*;
    use indra_providers::base::ProviderDescriptor as _;
