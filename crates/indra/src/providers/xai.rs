...
pub fn xai_known_model_info() -> Vec<indra_providers::base::ModelInfo> {
    XAI_KNOWN_MODELS
        .iter()
        .map(|model_name| {
            indra_providers::base::model_info_for_provider_model(XAI_PROVIDER_NAME, model_name)
        })
        .collect()
}

impl indra_providers::base::ProviderDescriptor for XaiProvider {
