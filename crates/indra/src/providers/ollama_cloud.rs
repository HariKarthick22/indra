...
use indra_providers::api_client::{ApiClient, AuthMethod, TlsConfig};
use indra_providers::base::{ModelInfo, ProviderDescriptor};
use indra_providers::errors::ProviderError;
use indra_providers::model::ModelConfig;
use indra_providers::ollama::fetch_ollama_model_names;
use indra_providers::openai::OpenAiProvider;
use rmcp::model::Tool;
...
fn build_ollama_api_client(
    ...
    let normalized_base_url = indra_providers::openai::ensure_url_scheme(&config.base_url);
...
impl Provider for OllamaCloudProvider {
    ...
    fn retry_config(&self) -> indra_providers::retry::RetryConfig {
    ...
    async fn get_context_limit(&self, model: &str, override_limit: Option<usize>) -> usize {
        ...
        indra_providers::context_limit::ContextLimitResolver::new(self.get_name())
