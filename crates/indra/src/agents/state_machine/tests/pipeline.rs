...
impl Provider for FeatureProvider {
    ...
    ) -> Result<crate::providers::base::MessageStream, indra_providers::errors::ProviderError> {
        self.inner
    ...
    async fn fetch_model_info(
        &self,
        model_name: &str,
    ) -> Result<indra_providers::base::ModelInfo, indra_providers::errors::ProviderError> {
...
async fn test_pipeline_with_components(
    ...
    let session = session_manager
        ...
        .await?;
    let model_config = ModelConfig::new(indra_providers::openai::OPEN_AI_DEFAULT_MODEL)
...
async fn build_test_pipeline(
    ...
    let api_client = indra_providers::api_client::ApiClient::new_with_tls(
        api.uri(),
        indra_providers::api_client::AuthMethod::NoAuth,
        None,
    )?;
    let provider: Arc<dyn Provider> = Arc::new(
        indra_providers::openai::OpenAiProviderBuilder::new(api_client)
            .name(provider_name)
