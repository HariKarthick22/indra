...
use indra_agent::operation::messages_since_kickoff;
...
impl SummonClient {
    ...
    ) -> Result<indra_providers::model::ModelConfig, anyhow::Error> {
...
You review code."#;
    ...
    async fn test_resolve_provider_reuses_unregistered_parent_provider() {
        ...
        *extension_manager.get_provider().lock().await = Some(Arc::clone(&parent_provider));
        ...
        let session = crate::session::Session {
            ...
            model_config: Some(indra_providers::model::ModelConfig::new("test-model")),
            ..Default::default()
        };
    ...
    fn session_with(parent: indra_providers::model::ModelConfig) -> crate::session::Session {
    ...
    fn resolve_with_override(
        model: Option<&str>,
        parent: indra_providers::model::ModelConfig,
    ) -> indra_providers::model::ModelConfig {
        let client = SummonClient::new(create_test_context()).unwrap();
        let params = DelegateParams {
    ...
    fn parent_config() -> indra_providers::model::ModelConfig {
        indra_providers::model::ModelConfig::new(PARENT_MODEL).with_canonical_limits(PROVIDER)
    }
    ...
    async fn test_resolve_model_config_applies_canonical_limits_to_overridden_model() {
        ...
        let overridden = indra_providers::model::ModelConfig::new(OVERRIDE_MODEL)
    ...
    async fn test_resolve_model_config_env_provider_uses_provider_default_model() {
        ...
        let session = crate::session::Session {
            ...
            model_config: Some(indra_providers::model::ModelConfig::new(
                "parent-openai-model",
            )),
            ..Default::default()
        };
