...
use crate::indra_apps::McpAppResource;
use crate::indra_apps::{GooseApp, McpAppCache, WindowProps};
...
const CLOCK_HTML: &str = include_str!("../../indra_apps/clock.html");
...
impl AppsManagerClient {
    ...
    async fn effective_model_config(
        ...
        session_id: &str,
        provider_name: &str,
    ) -> Result<indra_providers::model::ModelConfig, String> {
...
mod tests {
    ...
    async fn app_content_completion_uses_toolshim() {
        ...
        let model_config =
            indra_providers::model::ModelConfig::new("test-model").with_toolshim(true);
