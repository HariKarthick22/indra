pub use indra_context_management::structured;
...
pub use indra_context_management::DEFAULT_COMPACTION_THRESHOLD;
...
impl indra_context_management::CompactionModel for GooseCompactionModel<'_> {
    async fn complete(
        &self,
        system: &str,
        messages: &[Message],
...
#[async_trait::async_trait]
impl indra_context_management::TokenEstimator for GooseTokenEstimator {
...
fn compaction_templates() -> Result<indra_context_management::Templates> {
    Ok(indra_context_management::Templates {
...
async fn do_compact(
    ...
    let summary = indra_context_management::summarize(
        &model,
...
pub use indra_context_management::format_message_for_compacting;
