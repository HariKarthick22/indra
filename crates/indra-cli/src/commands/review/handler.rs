...
use indra::checks::{discover, DiscoveredReview};
use indra::subprocess::git_command;
...
/// `discovery_root` so [`indra::checks::discover`] doesn't double-
