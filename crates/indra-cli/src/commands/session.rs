...
pub async fn handle_session_import(input: String, nostr: bool) -> Result<()> {
    ...
    let format = indra::session::import_formats::detect_format(&json);
    let label = match format {
        indra::session::import_formats::ImportFormat::Goose => "goose",
        indra::session::import_formats::ImportFormat::ClaudeCode => "Claude Code",
        indra::session::import_formats::ImportFormat::Codex => "Codex",
        indra::session::import_formats::ImportFormat::Pi => "Pi",
    };
